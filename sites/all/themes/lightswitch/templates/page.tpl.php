...
<div id="page"><div class="inner group">
  ...
  <div id="main-content" class="clearfix">
    ...
    <?php if ($title && !$is_front && !$videographer): ?><h1 class="page-title"><?php print $title ?></h1><?php endif; ?>
...
<div id="bottom"><div class="inner group">
  <?php print $feed_icons ?>
  <?php print render($page['bottom']) ?>
</div></div>

<div id="footer"><div class="inner group">
  <?php print $feed_icons ?>
