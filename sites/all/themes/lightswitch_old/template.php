 ...
 * - toolbar.css
 */
function lightswitch_css_alter(&$css) {
  $exclude = array(
 ...
 */
function lightswitch_preprocess_html(&$vars) {
 ...
 */
function lightswitch_preprocess_page(&$vars) {
 ...
 */
function lightswitch_preprocess_block(&$vars) {
  $vars['hook'] = 'block';
 ...
 */
function lightswitch_preprocess_node(&$vars) {
  $vars['hook'] = 'node';
 ...
 */
function lightswitch_preprocess_comment(&$vars) {
  $vars['hook'] = 'comment';
 ...
 */
function lightswitch_preprocess_fieldset(&$vars) {
 ...
 */
function lightswitch_preprocess_field(&$vars) {
 ...
 */
function lightswitch_textarea($variables) {
 ...
 */
function lightswitch_pager($vars) {
  $tags = $vars['tags'];
  $element = $vars['element'];
 ...
 */
function lightswitch_pager_list($vars) {
  $tags = $vars['tags'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
  $quantity = $vars['quantity'];
  ...
  if ($pager_total[$element] > 1) {
    ...
    if ($i != $pager_max) {
      ...
      return theme('links', array(
        'links' => $links,
        'attributes' => array('class' => 'pager-items')
      ));
    }
  }
  return '';
 ...
 */
function lightswitch_pager_link($vars) {
  $text = $vars['text'];
 ...
 */
function lightswitch_views_mini_pager($vars) {
  $tags = $vars['tags'];
  $quantity = $vars['quantity'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
