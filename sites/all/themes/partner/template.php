 ...
 * - toolbar.css
 */
function partner_css_alter(&$css) {
  $exclude = array(
...
function partner_theme() {
  ...
  $items['block'] = array(
    ...
    'template' => 'object',
    'path' => drupal_get_path('theme', 'partner') .'/templates',
  );
  $items['comment'] = array(
 ...
 */
function partner_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'partner';
}

/**
 * Implementation of preprocess_page().
 */
function partner_preprocess_page(&$vars) {
 ...
 */
function partner_preprocess_block(&$vars) {
  $vars['hook'] = 'block';
 ...
 */
function partner_preprocess_node(&$vars) {
  $vars['hook'] = 'node';
 ...
 */
function partner_preprocess_comment(&$vars) {
  $vars['hook'] = 'comment';
 ...
 */
function partner_preprocess_fieldset(&$vars) {
 ...
 */
function partner_preprocess_field(&$vars) {
 ...
 */
function partner_textarea($variables) {
 ...
 */
function partner_pager_list($vars) {
  $tags = $vars['tags'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
  $quantity = $vars['quantity'];
 ...
 */
function partner_pager_link($vars) {
  $text = $vars['text'];
 ...
 */
function partner_views_mini_pager($vars) {
  $tags = $vars['tags'];
  $quantity = $vars['quantity'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
 ...
 */
function partner_image_style($variables) {
 ...
 */
function partner_date_all_day_label(){
	return t('');
}
